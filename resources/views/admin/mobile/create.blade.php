        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/mobile') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> ย้อนกลับ</button></a>
                        <br />
                        <br />
                        ...
                        <form method="POST" action="{{ url('/admin/posts') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            @include ('admin.mobile.form', ['formMode' => 'create'])
