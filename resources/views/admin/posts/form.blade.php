<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    <label for="image" class="control-label">{{ 'รูปสัตว์เลี้ยง' }}</label>
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="user_id" type="text" id="user_id" required value="{{ isset($post->user_id) ? $post->user_id : ''}}" >
